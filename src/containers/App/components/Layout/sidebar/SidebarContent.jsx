    ...
    return (
      <div className="sidebar__content">
        <ul className="sidebar__block">
          ...
          <SidebarLink title="Admin" icon="users" route="/setting" onClick={this.hideSidebar} />
          {/* <SidebarLink title="WIP Costs" icon="Documentation" route="/wip-costs-user" onClick={this.hideSidebar} />
          <SidebarLink title="WIP Costs Table" icon="Documentation" route="/wip-costs-table" onClick={this.hideSidebar} />
          <SidebarLink title="WIP Scale of Fees" icon="Documentation" route="/wip-scale-of-fees" onClick={this.hideSidebar} />
          <SidebarLink title="Debtor" icon="Documentation" route="/debtor" onClick={this.hideSidebar} /> */}
          
          

          {/* {
            this.state.staffData && this.state.staffData.length > 10 ? 
            <div className="custom-control custom-switch">
              <input type="checkbox" className="custom-control-input" name="Invoice_Contact" id='loadmore' checked={this.state.isFullLoaded} onChange={this.handleLoadMore}/>
              <label className="custom-control-label" for="Load More">Full Team</label>
            </div> : ''
          } */}
        ...
        <ul className="sidebar__block">
          <SidebarCategory title="Account" icon="user">
            ...
            <SidebarLink title="Log In Photo" route="/login_photo" />
